...
public class TrainingServiceImpl implements TrainingService {
    ...
    public List<Training> getTrainings() {
        final Course[] courses = this.restTemplate.getForObject(this.coursesMsUrl + COURSES_PATH, Course[].class);
    ...
    public void newTraining(Training training) {
        if (!this.existsCourseByName(training.getCourse())) {
            this.restTemplate.postForLocation(this.coursesMsUrl + COURSES_PATH, this.getCourseFromTraining(training));
        }
    }
